...
const defaultMeta = {
  ...
  description:
    'Seminar Proposal Tugas Akhir - PERANCANGAN DESIGN SYSTEM PADA PERANGKAT LUNAK DI CV. AKSES DIGITAL.',
  type: 'website',
  robots: 'follow, index',
};
...
const MyApp = ({ Component, pageProps, router }) => {
  ...
  return (
    <>
      <Title suffix="Tugas Akhir">{meta.title}</Title>
      <Head>
        ...
        {meta.date && (
          <>
            <meta name="author" property="article:author" content="Apriansyah Rizqi Setiawan" />
